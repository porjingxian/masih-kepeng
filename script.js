document.addEventListener("DOMContentLoaded", function() {
    ...
    animatedText.style.animation = "initialAnimation 2s ease-in-out";

    const animatedImage = document.getElementById("animatedImage");
    function applyShrinkEnlargeAnimation() {
        animatedImage.style.animation = "shrinkEnlargeAnimation 2s infinite alternate ease-in-out";
    }
    animatedImage.style.animation = "initialAnimation 2s ease-in-out";
    animatedImage.addEventListener("animationend", applyShrinkEnlargeAnimation);
});
